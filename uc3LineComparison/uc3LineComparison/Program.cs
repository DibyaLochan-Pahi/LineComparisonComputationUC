...
namespace uc3LineComparison
{
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            {
                Console.WriteLine("\nLine-1 ({0}) is Greater than Line-2 ({1})",finalResult1,finalResult2);
            }
            ...
            {
                Console.WriteLine("Line-1 ({0}) and Line-2 ({1}) are Equals",finalResult1,finalResult2);
            }
